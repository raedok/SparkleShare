...
namespace SparkleShare
{
    ...
    public static class UserInterfaceBootloaderHelpers
    {
        ...
        public static BitmapFrame GetImageSource(string name, string type)
        {
            ...
            Stream image_stream = assembly.GetManifestResourceStream("SparkleShare.Windows.Bootloader.Images." + name + "." + type);
        ...
        {
            Assembly assembly = Assembly.GetExecutingAssembly();
            Stream image_stream = assembly.GetManifestResourceStream("SparkleShare.Windows.Bootloader.Images." + name + ".png");
