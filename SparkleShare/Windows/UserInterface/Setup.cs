                        ...
                        case PageType.Add:
                            {
                                ...
                                CheckBox history_check_box = new CheckBox()
                                {
                                    ...
                                    IsChecked = Controller.FetchPriorHistory & false,
                        ...
                        case PageType.StorageSetup:
                            {
                                ...
                                Panel layout_vertical = new DockPanel();
                                Panel layout_radio_buttons = new StackPanel();
                                ...
                                foreach (StorageTypeInfo storage_type in SparkleShare.Controller.FetcherAvailableStorageTypes)
                                {
                                    ...
                                    radio_button.Content = storage_type.Name + "\n" + storage_type.Description;
                                ...
                                layout_vertical.Children.Add(layout_radio_buttons);
                                ContentCanvas.Children.Add(layout_vertical);

                                Canvas.SetLeft(layout_vertical, 185);
                                Canvas.SetTop(layout_vertical, 80);
                                ...
                                continue_button.Click += delegate
                                {
                                    ...
                                    foreach (RadioButton radio_button in layout_radio_buttons.Children)
                                    {
                                        if (radio_button.IsChecked == true)
                                        {
                                            ...
                                            SparkleShare.Controller.FinishFetcher(selected_storage_type.Type);
                                            return;
                                        }
